...
const itProgram=["MERN Stack","MEAN Stack" ,"PERN Stack", "Flutter ","React Native","UI/UX Design","Graphic Design",];
    ...
    return (
        <div ref={dropdownRef} className={`relative ${widthClass}`}>
            ...
            >
                ...
                {/* <span className='ml-3 text-[#6b7280]'>▾</span> */}
            </button>
...
//   const {theme} = useGlobal();
  ...
  const validateField = (name, value, fileValue) => {
    if (!name || name === 'passport') return ''; // passport is optional
  ...
  const handleChange = (event) => {
    ...
    // Validate on change and remove error if valid
...
const handleSubmit = async (e) => {
  ...
  for(let field in applyForm){
    if (applyForm[field]) { // only append non-empty fields
  ...
  return (
    <div className={`${theme === 'light' ? 'bg-white text-black':'bg-[#080808] text-white'} flex  flex-col   w-full `}>
        ...
        {/* <AdminLeftSidebar className="w-[20%]" /> */}
                <form onSubmit={handleSubmit} className={`w-[95%] max-w-[1280px] flex flex-col items-start gap-2 border border-[#cdd3d9] rounded-md bg-[#f2f6f8] p-4 sm:p-6 md:p-8 mt-20 mb-10 mx-auto`}>
            ...
            <div className='grid w-full grid-cols-1 gap-4 pt-4 md:grid-cols-2'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <input type='text' name='email' onChange={handleChange} value={applyForm.email}  placeholder='email' className={fieldClassName} required />
            ...
            <div className='grid w-full grid-cols-1 gap-4 pt-4 md:grid-cols-2'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <input type='number' name='phoneNumber' onChange={handleChange} value={applyForm.phoneNumber} placeholder='phone number' className={fieldClassName} required />
            ...
            <div className='grid w-full grid-cols-1 gap-4 pt-4 md:grid-cols-2'>
                <div className='flex flex-col gap-2'>
                    ...
                    <input type='number' name='CNIC' onChange={handleChange} value={applyForm.CNIC} placeholder='without dashes' className={fieldClassName} required />
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <input type='number' name='parentsCNIC' onChange={handleChange} value={applyForm.parentsCNIC} placeholder='without dashes' className={fieldClassName} required />
